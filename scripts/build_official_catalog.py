...
extracted observations remain candidates until evidence promotion.
"""
...
def main():
    ...
    free=[r for r in rows if r["Price Status"].startswith("✅")]
    ...
    print(f"records={len(rows)} free_core={len(free)} conditional={len(conditional)}")
